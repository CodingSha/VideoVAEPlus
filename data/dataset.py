...
class DatasetVideoLoader(Dataset):
    ...
    def __getitem__video(self, index):
        ...
        assert frames.shape[2] == self.resolution[0] and frames.shape[3] == self.resolution[1], \
    ...
    def __getitem__images(self, index):
        ...
        for i in range(self.video_length):
            ...
            frame_tensor = torch.tensor(frame.asnumpy()).permute(2, 0, 1).float().unsqueeze(0)  # [h,w,c] -> [c,h,w] -> [1, c, h, w]
